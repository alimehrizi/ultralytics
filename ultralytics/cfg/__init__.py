...
TASKS = 'detect','detrack', 'segment', 'classify', 'pose'
TASK2DATA = {'detect': 'coco8.yaml','detrack': 'coco8.yaml', 'segment': 'coco8-seg.yaml', 'classify': 'imagenet100', 'pose': 'coco8-pose.yaml'}
TASK2MODEL = {
    'detect': 'yolov8n.pt',
